...
namespace GoogleUiTests3
{
    ...
    public class ChromeTestCollection : IDisposable
    {
        private IWebDriver driver;
        public ChromeTestCollection()
        {
#if REMOTE
    ...
    public class FirefoxTestCollection : IDisposable
    {
        private IWebDriver driver;
        public FirefoxTestCollection()
        {
#if REMOTE
    ...
    {
        public static void Pause(int delay = 3000)
        {
#if !REMOTE
